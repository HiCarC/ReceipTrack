...
import { MapPin, Filter, Calendar, DollarSign, TrendingUp, Globe, Layers, Download, Share2 } from 'lucide-react';
...
export default function MapPage() {
  ...
  useEffect(() => {
    ...
    locatedReceipts.forEach(receipt => {
      ...
      locationSpending[location] = (locationSpending[location] || 0) + (parseFloat(receipt.total) || 0);
    });
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="p-2 rounded-lg bg-slate-700/30 border border-slate-600/30">
                    ...
                    <div className="font-medium text-white">
                      {formatCurrency(selectedReceipt.total, selectedReceipt.currency || settings?.baseCurrency || 'EUR')}
                    </div>
                  </div>
                  <div className="p-2 rounded-lg bg-slate-700/30 border border-slate-600/30">
