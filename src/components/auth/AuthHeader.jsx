...
import { Settings as SettingsComponent, UnifiedEditAvatarModal } from '@/components/settings/Settings';
...
export default function AuthHeader() {
  ...
  return (
    <header className={`hidden fixed top-0 left-0 right-0 z-50 transition-all duration-300 w-full overflow-x-hidden overflow-y-hidden ${
      isScrolled 
